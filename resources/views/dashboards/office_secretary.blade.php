<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">🗃️ Office Secretary Dashboard</h2>
    </x-slot>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach(['Correspondence & Filing', 'Inventory / Store', 'Visitor & Appointments', 'Memos & Circulars', 'Document Requests', 'Front Desk'] as $card)
