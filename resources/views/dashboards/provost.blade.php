    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <a href="{{ route('signature.edit') }}" class="bg-white p-6 rounded-2xl shadow-sm border hover:shadow-md transition">
                    <h3 class="font-bold text-gray-800">My E-Signature</h3>
                    <p class="text-sm text-gray-500 mt-1">Upload or draw your signature — for transcripts, testimonials &amp; statements of result.</p>
                </a>
            </div>
